...
Another example of a parameterised family of boolean operators is the \textit{weighted non-linear logic} (WNL). WNL is a generalisation of Łukasiewicz which introduces a bias term $\beta$, which mirrors the bias used in perceptron layers of classical NN architectures. 
